/**
  ...
  GRBL 1.1 Laser post processor configuration.
  Based on an old Tiny G Post processor
*/

description = "JTech Laser";
vendor = "";
vendorUrl = "";
legal = "";
...
properties = {
  ...
  useLaser: true, // allows you to use laser on and off with the spindle speed of that cut before and after retract
  grbl30Value: 0, //Sets the minimum Laser Value from your controller
  grbl31Value: 10000 // Sets the maxium Laser power value from your controller
  };
...
function onSection() {
  ...
  newSpindleSpeed = (tool.spindleRPM / 10000) * (properties.grbl31Value - properties.grbl30Value);
...
function onMovement(movement) {
  ...
  var newSpindleSpeed = (tool.spindleRPM / 10000) * (properties.grbl31Value - properties.grbl30Value);
  
  switch (movement) {
    case MOVEMENT_CUTTING:
      if(!tool.spindleActivated){
        writeBlock(mFormat.format(3) + " " + sOutput.format(newSpindleSpeed));
        tool.spindleActivated = true;
       }
    break;
